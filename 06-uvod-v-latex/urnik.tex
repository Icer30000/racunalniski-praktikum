...
\begin{enumerate}
   ...
   $\text{srečanja}_i$, ki ga sestavlja $\text{predmet}_j$, profesor, ki ta predmet predava,
   ...
   vstavljanja, da bomo $\text{predmet}_j$ na koncu vstavili v termin z najboljšo
   ceno vstavljanja.
